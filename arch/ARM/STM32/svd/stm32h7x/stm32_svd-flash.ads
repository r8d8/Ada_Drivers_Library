...
package STM32_SVD.Flash is
   ...
   subtype ACR_LATENCY_Field is STM32_SVD.UInt4;
   subtype ACR_WRHIGHFREQ_Field is STM32_SVD.UInt2;
   ...
   type OPTSR_CUR_Register is record
      ...
      --  unspecified
      Reserved_22_28 : STM32_SVD.UInt7 := 16#0#;
   ...
   subtype WPSN_CUR1R_WRPSn1_Field is STM32_SVD.Byte;
   ...
   subtype WPSN_PRG1R_WRPSn1_Field is STM32_SVD.Byte;
   ...
   subtype BOOT_CURR_BOOT_ADD_Element is STM32_SVD.UInt16;
   ...
   subtype BOOT_PRGR_BOOT_ADD_Element is STM32_SVD.UInt16;
   ...
   subtype CRCSADD1R_CRC_START_ADDR_Field is STM32_SVD.UInt18;
   ...
   subtype CRCEADD1R_CRC_END_ADDR_Field is STM32_SVD.UInt18;
   ...
   subtype ECC_FA1R_FAIL_ECC_ADDR1_Field is STM32_SVD.UInt15;
   ...
   subtype WPSN_CUR2R_WRPSn2_Field is STM32_SVD.Byte;
   ...
   subtype WPSN_PRG2R_WRPSn2_Field is STM32_SVD.Byte;
   ...
   subtype CRCSADD2R_CRC_START_ADDR_Field is STM32_SVD.UInt18;
   ...
   subtype CRCEADD2R_CRC_END_ADDR_Field is STM32_SVD.UInt18;
   ...
   subtype ECC_FA2R_FAIL_ECC_ADDR2_Field is STM32_SVD.UInt15;
   ...
   type Flash_Peripheral is record
      ...
      CRCDATAR    : aliased STM32_SVD.UInt32;
      --  FLASH ECC fail address for bank 1
      ...
      --  FLASH option key register
      OPTKEYR_1   : aliased STM32_SVD.UInt32;
      --  FLASH control register for bank 2
      ...
      --  FLASH CRC data register
      CRCDATAR_1  : aliased STM32_SVD.UInt32;
      --  FLASH ECC fail address for bank 2
