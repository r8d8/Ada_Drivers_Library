...
package STM32_SVD.OPAMP is
   ...
   subtype OPAMP1_OTR_TRIMOFFSETN_Field is STM32_SVD.UInt5;
   subtype OPAMP1_OTR_TRIMOFFSETP_Field is STM32_SVD.UInt5;
   ...
   subtype OPAMP1_HSOTR_TRIMLPOFFSETN_Field is STM32_SVD.UInt5;
   subtype OPAMP1_HSOTR_TRIMLPOFFSETP_Field is STM32_SVD.UInt5;
   ...
   subtype OPAMP2_OTR_TRIMOFFSETN_Field is STM32_SVD.UInt5;
   subtype OPAMP2_OTR_TRIMOFFSETP_Field is STM32_SVD.UInt5;
   ...
   subtype OPAMP2_HSOTR_TRIMLPOFFSETN_Field is STM32_SVD.UInt5;
   subtype OPAMP2_HSOTR_TRIMLPOFFSETP_Field is STM32_SVD.UInt5;
