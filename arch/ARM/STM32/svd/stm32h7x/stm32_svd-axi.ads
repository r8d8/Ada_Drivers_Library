...
package STM32_SVD.AXI is
   ...
   subtype AXI_PERIPH_ID_4_JEP106CON_Field is STM32_SVD.UInt4;
   subtype AXI_PERIPH_ID_4_KCOUNT4_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_PERIPH_ID_0_PARTNUM_Field is STM32_SVD.Byte;
   ...
   subtype AXI_PERIPH_ID_1_PARTNUM_Field is STM32_SVD.UInt4;
   subtype AXI_PERIPH_ID_1_JEP106I_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_PERIPH_ID_3_CUST_MOD_NUM_Field is STM32_SVD.UInt4;
   subtype AXI_PERIPH_ID_3_REV_AND_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_COMP_ID_0_PREAMBLE_Field is STM32_SVD.Byte;
   ...
   subtype AXI_COMP_ID_1_PREAMBLE_Field is STM32_SVD.UInt4;
   subtype AXI_COMP_ID_1_CLASS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_COMP_ID_2_PREAMBLE_Field is STM32_SVD.Byte;
   ...
   subtype AXI_COMP_ID_3_PREAMBLE_Field is STM32_SVD.Byte;
   ...
   subtype AXI_INI1_READ_QOS_AR_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI1_WRITE_QOS_AW_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI2_READ_QOS_AR_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI2_WRITE_QOS_AW_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI3_READ_QOS_AR_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI3_WRITE_QOS_AW_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI4_READ_QOS_AR_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI4_WRITE_QOS_AW_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI5_READ_QOS_AR_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI5_WRITE_QOS_AW_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI6_READ_QOS_AR_QOS_Field is STM32_SVD.UInt4;
   ...
   subtype AXI_INI6_WRITE_QOS_AW_QOS_Field is STM32_SVD.UInt4;
