...
package STM32_SVD.FDCAN is
   ...
   subtype CREL_DAY_Field is STM32_SVD.Byte;
   subtype CREL_MON_Field is STM32_SVD.Byte;
   subtype CREL_YEAR_Field is STM32_SVD.UInt4;
   subtype CREL_SUBSTEP_Field is STM32_SVD.UInt4;
   subtype CREL_STEP_Field is STM32_SVD.UInt4;
   subtype CREL_REL_Field is STM32_SVD.UInt4;
   ...
   subtype CCFG_TQBT_Field is STM32_SVD.UInt5;
   subtype CCFG_OCPM_Field is STM32_SVD.Byte;
   subtype CCFG_CDIV_Field is STM32_SVD.UInt4;
   ...
   type CCFG_Register is record
      ...
      --  unspecified
      Reserved_20_30 : STM32_SVD.UInt11 := 16#0#;
      --  Software Reset
      SWR            : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CSTAT_OCPC_Field is STM32_SVD.UInt18;
   subtype CSTAT_TQC_Field is STM32_SVD.UInt11;
   subtype CSTAT_CALS_Field is STM32_SVD.UInt2;
   ...
   subtype CWD_WDC_Field is STM32_SVD.UInt16;
   subtype CWD_WDV_Field is STM32_SVD.UInt16;
   ...
   subtype FDCAN_TXEFS_EFPI_Field is STM32_SVD.UInt5;
   ...
   type FDCAN_TXEFS_Register is record
      ...
      EFPI           : FDCAN_TXEFS_EFPI_Field := 16#0#;
      --  unspecified
