...
package STM32_SVD.LPTIM is
   ...
   subtype CFGR2_IN1SEL_Field is STM32_SVD.UInt2;
   subtype CFGR2_IN2SEL_Field is STM32_SVD.UInt2;
   ...
   --  LPTIM configuration register 2
   type CFGR2_Register_1 is record
      --  LPTIM Input 1 selection
      IN1SEL        : CFGR2_IN1SEL_Field := 16#0#;
      --  unspecified
   ...
   for CFGR2_Register_1 use record
      IN1SEL        at 0 range 0 .. 1;
   ...
   type LPTIM3_Peripheral is record
      ...
      CNT   : aliased CNT_Register;
      --  LPTIM configuration register 2
      CFGR2 : aliased CFGR2_Register_1;
   end record
     with Volatile;
