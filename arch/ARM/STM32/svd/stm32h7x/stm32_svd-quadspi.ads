...
package STM32_SVD.QUADSPI is
   ...
   subtype SR_FLEVEL_Field is STM32_SVD.UInt6;
   ...
   subtype PIR_INTERVAL_Field is STM32_SVD.UInt16;
   ...
   subtype LPTR_TIMEOUT_Field is STM32_SVD.UInt16;
