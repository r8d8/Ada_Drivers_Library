...
package STM32_SVD.PWR is
   ...
   subtype CR1_SVOS_Field is STM32_SVD.UInt2;
   subtype CR1_ALS_Field is STM32_SVD.UInt2;
   ...
   subtype CSR1_ACTVOS_Field is STM32_SVD.UInt2;
   ...
   subtype D3CR_VOS_Field is STM32_SVD.UInt2;
   ...
   subtype WKUPCR_WKUPC_Field is STM32_SVD.UInt6;
   ...
   subtype WKUPEPR_WKUPPUPD_Element is STM32_SVD.UInt2;
