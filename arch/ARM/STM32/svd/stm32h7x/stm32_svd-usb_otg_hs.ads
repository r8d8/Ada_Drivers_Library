...
package STM32_SVD.USB_OTG_HS is
   ...
   subtype OTG_HS_DAINT_IEPINT_Field is STM32_SVD.UInt16;
   subtype OTG_HS_DAINT_OEPINT_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DAINTMSK_IEPM_Field is STM32_SVD.UInt16;
   subtype OTG_HS_DAINTMSK_OEPM_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DVBUSDIS_VBUSDT_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DIEPEMPMSK_INEPTXFEM_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DIEPCTL_MPSIZ_Field is STM32_SVD.UInt11;
   subtype OTG_HS_DIEPCTL_EPTYP_Field is STM32_SVD.UInt2;
   subtype OTG_HS_DIEPCTL_TXFNUM_Field is STM32_SVD.UInt4;
   ...
   subtype OTG_HS_DTXFSTS_INEPTFSAV_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DIEPTSIZ_XFRSIZ_Field is STM32_SVD.UInt19;
   subtype OTG_HS_DIEPTSIZ_PKTCNT_Field is STM32_SVD.UInt10;
   subtype OTG_HS_DIEPTSIZ_MCNT_Field is STM32_SVD.UInt2;
   ...
   subtype OTG_HS_DOEPCTL_MPSIZ_Field is STM32_SVD.UInt11;
   subtype OTG_HS_DOEPCTL_EPTYP_Field is STM32_SVD.UInt2;
   ...
   subtype OTG_HS_DOEPTSIZ_XFRSIZ_Field is STM32_SVD.UInt19;
   subtype OTG_HS_DOEPTSIZ_PKTCNT_Field is STM32_SVD.UInt10;
   subtype OTG_HS_DOEPTSIZ_RXDPID_STUPCNT_Field is STM32_SVD.UInt2;
   ...
   subtype OTG_HS_GRXFSIZ_RXFD_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HNPTXFSIZ_Host_NPTXFSA_Field is STM32_SVD.UInt16;
   subtype OTG_HS_HNPTXFSIZ_Host_NPTXFD_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DIEPTXF0_Device_TX0FSA_Field is STM32_SVD.UInt16;
   subtype OTG_HS_DIEPTXF0_Device_TX0FD_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_GNPTXSTS_NPTXFSAV_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HPTXFSIZ_PTXSA_Field is STM32_SVD.UInt16;
   subtype OTG_HS_HPTXFSIZ_PTXFD_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_DIEPTXF_INEPTXSA_Field is STM32_SVD.UInt16;
   subtype OTG_HS_DIEPTXF_INEPTXFD_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_DIEPTXF8_INEPTXSA_Field is STM32_SVD.UInt16;
   subtype OTG_DIEPTXF8_INEPTXFD_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HFIR_FRIVL_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HFNUM_FRNUM_Field is STM32_SVD.UInt16;
   subtype OTG_HS_HFNUM_FTREM_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HPTXSTS_PTXFSAVL_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HAINT_HAINT_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HAINTMSK_HAINTM_Field is STM32_SVD.UInt16;
   ...
   subtype OTG_HS_HCCHAR_MPSIZ_Field is STM32_SVD.UInt11;
   subtype OTG_HS_HCCHAR_EPNUM_Field is STM32_SVD.UInt4;
   subtype OTG_HS_HCCHAR_EPTYP_Field is STM32_SVD.UInt2;
   subtype OTG_HS_HCCHAR_MC_Field is STM32_SVD.UInt2;
   subtype OTG_HS_HCCHAR_DAD_Field is STM32_SVD.UInt7;
   ...
   subtype OTG_HS_HCSPLT_PRTADDR_Field is STM32_SVD.UInt7;
   subtype OTG_HS_HCSPLT_HUBADDR_Field is STM32_SVD.UInt7;
   subtype OTG_HS_HCSPLT_XACTPOS_Field is STM32_SVD.UInt2;
   ...
   subtype OTG_HS_HCTSIZ_XFRSIZ_Field is STM32_SVD.UInt19;
   subtype OTG_HS_HCTSIZ_PKTCNT_Field is STM32_SVD.UInt10;
   subtype OTG_HS_HCTSIZ_DPID_Field is STM32_SVD.UInt2;
   ...
   is record
      ...
      OTG_HS_DIEPDMA1    : aliased STM32_SVD.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA2    : aliased STM32_SVD.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA3    : aliased STM32_SVD.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA4    : aliased STM32_SVD.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA5    : aliased STM32_SVD.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
   ...
   is record
      ...
      OTG_HS_CID             : aliased STM32_SVD.UInt32;
      --  OTG core LPM configuration register
   ...
   for OTG1_HS_GLOBAL_Peripheral use record
      ...
      OTG_HS_DIEPTXF7        at 16#11C# range 0 .. 31;
   ...
   --  USB 1 on the go high speed
   OTG2_HS_GLOBAL_Periph : aliased OTG1_HS_GLOBAL_Peripheral
     with Import, Address => OTG2_HS_GLOBAL_Base;
   ...
   type OTG1_HS_HOST_Peripheral is record
      ...
      OTG_HS_HCDMA0     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA1     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA2     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA3     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA4     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA5     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA6     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA7     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA8     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA9     : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA10    : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA11    : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA12    : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA13    : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA14    : aliased STM32_SVD.UInt32;
      ...
      OTG_HS_HCDMA15    : aliased STM32_SVD.UInt32;
   end record
     with Volatile;
