...
package STM32_SVD.SDMMC is
   ...
   subtype CLKCR_CLKDIV_Field is STM32_SVD.UInt10;
   subtype CLKCR_WIDBUS_Field is STM32_SVD.UInt2;
   subtype CLKCR_SELCLKRX_Field is STM32_SVD.UInt2;
   ...
   subtype CMDR_CMDINDEX_Field is STM32_SVD.UInt6;
   subtype CMDR_WAITRESP_Field is STM32_SVD.UInt2;
   ...
   subtype RESPCMDR_RESPCMD_Field is STM32_SVD.UInt6;
   ...
   subtype DLENR_DATALENGTH_Field is STM32_SVD.UInt25;
   ...
   subtype DCTRL_DTMODE_Field is STM32_SVD.UInt2;
   ...
   subtype DCNTR_DATACOUNT_Field is STM32_SVD.UInt25;
   ...
   subtype ACKTIMER_ACKTIME_Field is STM32_SVD.UInt25;
   ...
   subtype IDMABSIZER_IDMABNDT_Field is STM32_SVD.Byte;
   ...
   subtype VER_MINREV_Field is STM32_SVD.UInt4;
   subtype VER_MAJREV_Field is STM32_SVD.UInt4;
   ...
   type SDMMC_Peripheral is record
      ...
      RESP1R     : aliased STM32_SVD.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP2R     : aliased STM32_SVD.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP3R     : aliased STM32_SVD.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP4R     : aliased STM32_SVD.UInt32;
      ...
      FIFOR      : aliased STM32_SVD.UInt32;
      --  SDMMC IP version register
      VER        : aliased VER_Register;
      --  SDMMC IP identification register
      ID         : aliased STM32_SVD.UInt32;
   end record
     with Volatile;
