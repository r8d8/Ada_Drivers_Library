...
package ADL_Config is
   ...
   Board                          : constant String  := "Matek_H743_Slim_V3"; -- From board definition
   CPU_Core                       : constant String  := "ARM Cortex-M7F";    -- From mcu definition
   Device_Family                  : constant String  := "STM32H7";           -- From board definition
   Device_Name                    : constant String  := "STM32H743VIHx";     -- From board definition
   ...
   Runtime_Name                   : constant String  := "ravenscar-full-stm32h7"; -- From runtime selection
   Runtime_Name_Suffix            : constant String  := "stm32h7";           -- From board definition
